...
export default function Home() {
  ...
  return (
    <main className="mx-auto max-w-lg px-5 py-14">
      ...
      <p className="mt-6 leading-relaxed text-gray-800">Print a sign with a QR code and stick it on whatever you are selling. Anyone walking past scans it and lands on a proper listing with photos, the price, a description and a button to call you.</p>
      ...
      <div className="mt-10 border-t border-gray-200 pt-8">
        {sent ? (
          ...
          <div>
            <p className="text-lg font-semibold">Want one?</p>
            <p className="mt-1 text-sm text-gray-600">I am testing this at the moment, so the first ones are free. Leave your email and I will make you one.</p>
            ...
            <button onClick={submit} disabled={busy} className="mt-4 w-full rounded-lg bg-black py-3.5 font-medium text-white">
              {busy ? 'Sending…' : 'Send'}
            </button>
